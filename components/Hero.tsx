  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl">
        ...
        <div className="reveal reveal-delay-1 pointer-events-none absolute left-0 top-16 select-none text-[18vw] font-black uppercase leading-none text-white/[0.035] md:text-[13vw]">
          DEVELOPER
        </div>
        ...
        <div className="relative z-10">
          ...
          <p className="reveal reveal-delay-2 mt-8 max-w-2xl text-base leading-relaxed text-gray-400 md:text-lg">
            Computer Science Engineering student building scalable full-stack
            applications, cloud-ready systems, DevOps workflows, and modern
          ...
          <div className="reveal reveal-delay-3 mt-10 flex flex-col gap-4 sm:flex-row">
            <button
              ...
              className="group rounded-full bg-cyan-400 px-8 py-4 font-semibold text-black transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-cyan-300 hover:shadow-2xl hover:shadow-cyan-500/30"
            >
              View Projects
            </button>
            ...
            <a
              ...
              className="rounded-full border border-white/10 bg-white/5 px-8 py-4 font-semibold text-white backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:border-cyan-400/30 hover:bg-white/10 hover:text-cyan-300"
            >
              View Resume
            </a>
          </div>
